...
GVAR(debugPFHID) = [{
...

    {
        ...
        _areaInfo params ["_area", "_logic", "_ratings", "_percentages"];
        ...
        private _marker = createMarkerLocal [format [QGVAR(debugMarker_areaText_%1), _forEachIndex], _position];
        ...
        _marker = createMarkerLocal [format [QGVAR(debugMarker_areaRatings_%1), _forEachIndex], [_position#0, _position#1 - 150, _position#2]];
