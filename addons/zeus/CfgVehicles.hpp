class CfgVehicles {
    ...
    class UKSF_Module_SmallExplosion: Ares_Spawn_Module_Base {
        ...
        portrait = QPATHTOF(UI\Icon_Module_Explosion_Small_ca.paa);
    };        
    class UKSF_Module_LargeExplosion: Ares_Spawn_Module_Base {
        ...
        portrait = QPATHTOF(UI\Icon_Module_Explosion_Large_ca.paa);
    };
    ...
    class UKSF_Module_ToggleAllowUnconcious: Achilles_ACE_Module_Base {
        ...
        portrait = "\z\ace\addons\zeus\ui\Icon_Module_Zeus_Unconscious_ca.paa";
    };
};
