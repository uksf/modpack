...
/*
    ...
    Example:
        [_selectedObjects, _selectedGroups] call uksf_zeus_fnc_contextSupportRadio
*/
...
if (_selectedGroups isNotEqualTo []) exitWith {
    ...
    private _state = [_selectedObjects, {_x getVariable [QEGVAR(mission,hasSupportRadio), true]}] call EFUNC(common,arrayAny);
