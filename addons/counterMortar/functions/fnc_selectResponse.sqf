...
private _forceChance = 6; // for debug
// private _forceChance = ceil(random 10);
...
if (_forceChance > 0 && _forceChance <= 5 && (count GVAR(groundVehicleTypes)) != 0) exitWith {
    [_bluforMortarPos,1] call FUNC(selectSpawnLocation);
};

////////////////////////////////////////////////////////////////
// helis dont land in MP, shelved for now
/*
// create a heli force
if (_forceChance > 3 && _forceChance <= 6 && (count GVAR(airVehicleTypes)) != 0) exitWith {
