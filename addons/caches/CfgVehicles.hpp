    ...
    class GVAR(cacheAreaModule) : GVAR(module) {
        ...
        class Attributes : AttributesBase {
            class GVAR(cacheNumber) {
                ...
                tooltip = "Number of caches to create";
                control = "Editshort";
                validate = "NUMBER";
                defaultValue = "3";
            ...
            class GVAR(cachePoolString) {
                ...
                tooltip = "Classnames of crates/boxes to use as caches. Comma-separated list of class names in single quotes, no spaces";
                control = "Edit";
                defaultValue = "[]";
            ...
            class GVAR(cacheContentPoolString) {
                ...
                tooltip = "Classnames of content to be placed in caches. Random amount of each item will be used. Comma-separated list of class names in single quotes, no spaces";
                control = "Edit";
                defaultValue = "[]";
