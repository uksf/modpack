...
params ["_numberOfUnitsToSpawn", "_side", "_module", "_unitPoolArray", "_currenGrouptUnitCount", "_patrolRadius"];
...
[{
    ...
    private _unit = _group createUnit [_unitType, getPos _module, [], 0, "NONE"];
