class CfgVehicles {
    ...
    class GVAR(logisticsStart) : GVAR(module) {
        ...
        class Attributes : AttributesBase {
            ...
            class GVAR(picketLocations) {
                property = QGVAR(picketLocations);
                displayName = "Picket Locations";
                tooltip = "% of the way along the route patrols will spawn. 0.4 = 40% e.g. [0.4,0.7]. Comma-separated list of numbers, no spaces";
                control = "Edit";
                defaultValue = "[40,70]";
                expression = QUOTE(_this setVariable [ARR_3(QQGVAR(picketLocations),_value,true)]);
            };
            ...
            class GVAR(logisticsObject) {
                property = QGVAR(logisticsObject);
                displayName = "Logistics Object";
                tooltip = "Logistics from this module will stop if this object is killed / destroyed. Requires static variable name e.g. 'officer1' or 'warehouse2'.";
                control = "Edit";
                defaultValue = "Warehouse1";
                expression = QUOTE(_this setVariable [ARR_3(QQGVAR(logisticsObject),_value,true)]);
            };
            class GVAR(logisticalVehicleNumber) {
                property = QGVAR(logisticalVehicleNumber);
                displayName = "Logistics Vehicle Pool";
                tooltip = "Number of vehicles this logistics module can use, only 1 will be active at any one time. When it reaches 0, logistics will stop. Number i.e. 3";
                control = "EditShort";
                validate = "NUMBER";
                defaultValue = "2";
                expression = QUOTE(_this setVariable [ARR_3(QQGVAR(logisticalVehicleNumber),_value,true)]);
            };
