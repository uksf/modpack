        ...
        class CUP_B_GB {
            ...
            class Infantry {
                ...
                class CUP_B_GB_AT_MTP {
                    ...
                    class Unit2 {
                        side = 1;
                        vehicle = "CUP_B_BAF_Soldier_AA_MTP";
                        rank = "PRIVATE";
                        position[] = { 5,0,0 };
                    };
                    class Unit3 {
            ...
            class Infantry_DDPM {
                ...
                class CUP_B_GB_Section_DDPM {
                    ...
                    class Unit1 {
                        side = 1;
                        vehicle = "CUP_B_BAF_Soldier_DDPM";
                        rank = "SERGEANT";
                        position[] = { 3,0,0 };
                    };
                    class Unit2 {
                ...
                class CUP_B_GB_AT_DDPM {
                    ...
                    class Unit2 {
                        side = 1;
                        vehicle = "CUP_B_BAF_Soldier_AA_DDPM";
                        rank = "PRIVATE";
                        position[] = { 5,0,0 };
                    };
                    class Unit3 {
            ...
            class Infantry_W {
                ...
                class CUP_B_GB_AT_W {
                    ...
                    class Unit2 {
                        side = 1;
                        vehicle = "CUP_B_BAF_Soldier_AA_WDL";
                        rank = "PRIVATE";
                        position[] = { 5,0,0 };
                    };
                    class Unit3 {
            ...
            class Motorized_MTP {
                ...
                class CUP_B_GB_MSection_W_Ridgback {
                    name = "Ridgback Section (Woodland)";
                    icon = "\A3\ui_f\data\map\markers\nato\b_motor_inf.paa";
                    faction = "CUP_B_GB";
                    side = 1;
                    rarityGroup = 0.1;
                ...
                class CUP_B_GB_MSection_W_Mastiff {
                    name = "Mastiff Section (Woodland)";
                    icon = "\A3\ui_f\data\map\markers\nato\b_motor_inf.paa";
                    faction = "CUP_B_GB";
                    side = 1;
                    rarityGroup = 0.1;
