...
#define CLOSEMISS_DECAY_K 0.015
#define CLOSEMISS_PRE_AGE_SEC 2
#define CLOSEMISS_PLAYER_FIRING_WINDOW 10
#define CLOSEMISS_FLINCH_MIN_DEG 3
#define CLOSEMISS_FLINCH_RAND_DEG 3
#define CLOSEMISS_SHAKE_FORCE 8
#define CLOSEMISS_SHAKE_LENGTH 0.4
#define CLOSEMISS_SHAKE_FREQ 4
#define CLOSEMISS_DETECTION_BASE 1.5
#define CLOSEMISS_DETECTION_BIG 2.5
