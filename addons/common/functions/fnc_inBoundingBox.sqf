...
/*
    ...
    Return value:
        Boolean
*/
params [["_object1", objNull, [objNull, []]], ["_object2", objNull, [objNull]]];

private _bb2 = boundingBoxReal _object2;
...
if (_pos inArea [_object2, _width, _length, getDir _object2, true]) exitWith {true};
...
_bb2 = [_object2, _bb2] call _getBoundingBox;
