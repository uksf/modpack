...
[{alive leader (_this select 0)},{
    ...
    [_group,_stagingArea,50,"MOVE","AWARE","YELLOW","NORMAL","FILE","uksf_groundCommander_readyAtStagingArea = uksf_groundCommander_readyAtStagingArea + 1;"] call cba_fnc_addWaypoint;
    ...
    [{
        ...
        [_group,_player,300,"GETOUT","AWARE","YELLOW","NORMAL","FILE","[this] call uksf_groundCommander_fnc_unloadTransport;"] call cba_fnc_addWaypoint;
