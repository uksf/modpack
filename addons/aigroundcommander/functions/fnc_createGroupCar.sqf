...
private _veh = createVehicle [selectRandom EGVAR(gear,gearCar),_safeSpawn];
...
private _count = (_veh emptyPositions "driver") + (_veh emptyPositions "cargo") + count _turrets;
