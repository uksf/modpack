...
class CUP_Creatures_Military_OPFINS_Soldier_Base: SoldierWB {
    identityTypes[] = {"LanguagePER_F", "Head_Greek", "G_GUERIL_default"};
};
class CUP_B_CZ_Soldier_base: SoldierWB {
    identityTypes[] = {"LanguagePER_F", "Head_NATO", "G_NATO_default"};
};
class CUP_B_CZ_Officer_DES: CUP_B_CZ_Soldier_base {
    identityTypes[] = {"LanguagePER_F", "Head_NATO", "G_NATO_casual"};
};
class CUP_B_CZ_Sniper: CUP_B_CZ_Soldier_base {
    identityTypes[] = {"LanguagePER_F", "Head_NATO", "G_NATO_sniper"};
};
class CUP_B_CZ_Officer_WDL: CUP_B_CZ_Soldier_base {
    identityTypes[] = {"LanguagePER_F", "Head_NATO", "G_NATO_casual"};
};
class SoldierGB;
class CUP_I_PMC_Soldier_Base: SoldierGB {
    identityTypes[] = {"LanguageENGB_F", "Head_Greek", "G_NATO_default"};
};
class CUP_I_PMC_Sniper: CUP_I_PMC_Soldier_Base {
    identityTypes[] = {"LanguageENGB_F", "Head_Greek", "G_NATO_sniper"};
};
class CUP_Creatures_Military_GER_Soldier_Base: SoldierWB {
    identityTypes[] = {"LanguageENGB_F", "Head_Euro", "G_GUERIL_default"};
};
class CUP_Creatures_Military_NAPA_Soldier_Base: SoldierWB {
    identityTypes[] = {"LanguageENGB_F", "Head_GUE", "G_GUERIL_facemask"};
};
class CUP_Creatures_Military_RACS_Soldier_Base: SoldierWB {
    identityTypes[] = {"LanguagePER_F", "Head_Euro", "G_GUERIL_default"};
};
