...
class GVAR(r2) : GVAR(rx) {
    ...
    class TransportMagazines {
        ...
        MACRO_ADDMAGAZINE(MAA_MAAWS_GMM_HE,10);
        MACRO_ADDMAGAZINE(MAA_MAAWS_GMM_HEAT,10);
        MACRO_ADDMAGAZINE(MAA_MAAWS_ASM509,10);
        MACRO_ADDMAGAZINE(MAA_MAAWS_HEDP502,10);
        MACRO_ADDMAGAZINE(MAA_MAAWS_MT756,10);
