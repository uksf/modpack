...
[QGVAR(correctPilotPylon), {_this call FUNC(correctPilotPylon)}] call CBA_fnc_addEventHandler;
["ace_rearm_loadoutChanged", {_this call FUNC(correctPilotPylon)}] call CBA_fnc_addEventHandler;
