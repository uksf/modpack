...
_waypoint setWaypointStatements [
    "true",
    format ["if !(isServer) exitWith {}; ['%1', [group this, vehicle this]] call CBA_fnc_localEvent; [group this, vehicle this] call %2;", QGVAR(missionComplete), QFUNC(cleanupAircraft)]
];
