...
#define WHITELIST [UID_BESWICK, UID_BRIDGFORD, UID_HANDISIDES, UID_FISHER, UID_JOHNSON]
#define WHITELIST_NOARRAY UID_BESWICK, UID_BRIDGFORD, UID_HANDISIDES, UID_FISHER, UID_JOHNSON
