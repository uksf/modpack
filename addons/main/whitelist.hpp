...
#define WHITELIST [UID_BESWICK, UID_BRIDGFORD, UID_HANDISIDES, UID_FISHER, UID_JOHNSON, UID_POT]
#define WHITELIST_NOARRAY UID_BESWICK, UID_BRIDGFORD, UID_HANDISIDES, UID_FISHER, UID_JOHNSON, UID_POT
