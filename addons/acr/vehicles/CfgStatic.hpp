...
class GVAR(Podnos) : CUP_O_2b14_82mm_SLA {
    scope = 2;
    side = 0;
    faction = QUOTE(ADDON);
    displayName = "Podnos";
...
class GVAR(ags) : CUP_O_AGS_RU_M_BeigeDigital {
    scope = 2;
    side = 0;
    faction = QUOTE(ADDON);
    displayName = "AGS";
...
class GVAR(M2_Raised) : I_HMG_02_high_F {
    scope = 2;
    side = 0;
    faction = QUOTE(ADDON);
...
class GVAR(TOW) : CUP_B_TOW2_TriPod_US {
    scope = 2;
    side = 0;
    faction = QUOTE(ADDON);
    displayName = "TOW";
