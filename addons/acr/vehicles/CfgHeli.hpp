...
class UKSF_ACR_Mi35: CUP_B_Mi35_Dynamic_CZ_Dark {
    scope = 2;
    side = 0;
    faction = "UKSF_ACR";
    displayName = "Mi35";
    // editorPreview = QPATHTOEF(common,data\previews\Inegal_Heli_AW101.jpg);
    crew = "UKSF_ACR_Heli_Pilot";
    typicalCargo[] = {
        "UKSF_ACR_Heli_Pilot"
    };
...
class UKSF_ACR_AH1Z: CUP_B_AH1Z_Dynamic_USMC {
    scope = 2;
    side = 0;
    faction = "UKSF_ACR";
    displayName = "AH1Z";
...
class UKSF_ACR_Mi17: CUP_B_Mi171Sh_Unarmed_ACR {
    scope = 2;
    side = 0;
    faction = "UKSF_ACR";
    displayName = "Mi17";
